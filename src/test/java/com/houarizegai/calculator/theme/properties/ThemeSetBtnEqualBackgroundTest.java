...
public class ThemeSetBtnEqualBackgroundTest {
	...
	@Test
	public void testSuccessfulSetBtnEqualBackground() {
		String btnEqualBackground = "#FFFFFF";
		theme.setBtnEqualBackground(btnEqualBackground);
		assertEquals(btnEqualBackground, theme.getBtnEqualBackground());
	}

	@Test
	public void testNullValueSetBtnEqualBackground() {
		theme.setBtnEqualBackground(null);
		assertNull(theme.getBtnEqualBackground());
	}

	@Test
	public void testSetBtnEqualBackgroundWithAppBackground() {
		String applicationBackground = "#FFFFFF";
		theme.setApplicationBackground(applicationBackground);
		theme.setBtnEqualBackground(applicationBackground);
		assertEquals(applicationBackground, theme.getBtnEqualBackground());
	}

	@Test
	public void testSetBtnEqualBackgroundWithNonString() {
		int btnEqualBackground = 12345;
		// TODO: User is supposed to convert int to String before passing
		theme.setBtnEqualBackground(String.valueOf(btnEqualBackground));
		assertEquals(String.valueOf(btnEqualBackground), theme.getBtnEqualBackground());
	}
