...
7. Scenario: Check if the function handles very long string input.
   Test: Provide a very long string for the btnEqualBackground parameter and check if the function handles it without throwing any errors or truncating the input.
...
public class Theme_setBtnEqualBackground_85fbd39ea7_Test {
    ...
    public void testSetBtnEqualBackground_ValidInput() {
        ...
        assertEquals(expectedBackground, theme.getBtnEqualBackground());
    }
    ...
    @Test
    public void testSetBtnEqualBackground_EmptyStringInput() {
    ...
    public void testSetBtnEqualBackground_LongStringInput() {
        String expectedBackground = "a".repeat(10000);
        theme.setBtnEqualBackground(expectedBackground);
        assertEquals(expectedBackground, theme.getBtnEqualBackground());
    }
