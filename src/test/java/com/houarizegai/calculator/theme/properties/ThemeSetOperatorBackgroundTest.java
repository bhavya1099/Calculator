...
class ThemeSetOperatorBackgroundTest {
	...
	private static ThemeSetOperatorBackground themeSetOperatorBackgroundTest = null;

	@BeforeAll
	public static void setUp() {
		themeSetOperatorBackgroundTest = new ThemeSetOperatorBackground();
	}

	@Test
	public void checkSuccessfulOperatorBackgroundSet() {
		themeSetOperatorBackgroundTest.setOperatorBackground("blue");
		assertEquals("blue", themeSetOperatorBackgroundTest.getOperatorBackground());
	}

	@Test
	public void checkNullOperatorBackgroundSet() {
		themeSetOperatorBackgroundTest.setOperatorBackground(null);
		assertNull(themeSetOperatorBackgroundTest.getOperatorBackground());
	}
	...
	public void checkLargeStringOperatorBackgroundSet() {
		...
		assertEquals(largeString, themeSetOperatorBackgroundTest.getOperatorBackground());
	}
