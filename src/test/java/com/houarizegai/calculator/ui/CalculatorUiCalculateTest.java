...
public class CalculatorUiCalculateTest {
	...
	@Test    public void testCalculateWithUnrecognizedOperation() {        double firstNumber = 7.5;        double secondNumber = 2.5;        char operator = 'x';        double expected = 2.5;        double actual = calculator.calculate(firstNumber, secondNumber, operator);        assertEquals(expected, actual, 0.0);
