...
public class branchesIdDeleteTest {
    ...
    public void setUp() {
        ...
        envList = dataLoader.loadData("src/test/java/com/houari/RoostTest/branches_idDeleteTest.csv");
    }

    @Test
    public void branchesIdDelete_Test() {
        this.setUp();
