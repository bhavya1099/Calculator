...
public class credentialsIdDeleteTest {
    ...
    public void setUp() {
        ...
        envList = dataloader.loadData("src/test/java/com/houari/RoostTest/credentials_idDeleteTest.csv");
    }

    @Test  
    public void credentialsIdDelete_Test() {
        this.setUp();
    ...
    private void validateErrorResponse(Response response) {
        ...
        MatcherAssert.assertThat(response.jsonPath().get("value"), instanceOf(Object.class));
    }
